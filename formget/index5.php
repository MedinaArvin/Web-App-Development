	...
	<link rel="stylesheet" type="text/css" href="style.css">
		...
		<form action = 'index6.php' method = 'get'>
			<table border='1'>
				...
				<tr>
					<td colspan = '3'>
						<input type = 'radio' name = 'type' value = 'FULLscholar'>Full Scholar</input><br>
						<input type = 'radio' name = 'type' value = 'PARTIALscholar'>Partial Scholar</input><br>
						<input type = 'radio' name = 'type' value = 'FULLpayee'>Full Payee</input>
					</td>
				</tr>
				<tr>
